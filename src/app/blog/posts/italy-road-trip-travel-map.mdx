...
<Step num="01" title="Mark the cities along the route">
  I opened the [Android app](https://play.google.com/store/apps/details?id=app.cinemaly) and started marking cities in order: Milan, Como, Cinque Terre, Florence, Siena, Rome, Naples, Amalfi, Palermo. The route drew itself on the map as I added each stop — already more satisfying than a flat album.
</Step>
...
_Cinemaly is free on [iOS](https://apps.apple.com/us/app/cinemaly/id6763919834), [Android](https://play.google.com/store/apps/details?id=app.cinemaly), and at [cinemaly.app](/) in the browser._
