...
What caught my attention wasn't the feature list. It was the fact that my photos would not be uploaded to a Cinemaly server. I'd gotten quietly tired of feeding my travel photos into platforms that store them indefinitely, optimize them into their own formats, and show them in whatever order their algorithm prefers. The idea of a tool that processes the capsule locally and gives you back a file felt almost old-fashioned in the best way.
